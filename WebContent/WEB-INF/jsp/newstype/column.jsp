...
<body>
	...
	<div class="row-fluid">
		...
		<header class="header">
		<h4 class="title">${requestScope.newsType.typeName }专栏</h4>
		</header>
		...
		<div class="m-pagination pull-right">
			<a href="${pageContext.request.contextPath}/newstype/column/${requestScope.newsType.id }/1">首页</a>
			<c:if test="${requestScope.page.currentPage != 1 }">
				<a href="${pageContext.request.contextPath}/newstype/column/${requestScope.newsType.id }/${requestScope.page.currentPage }-1">上一页</a>
			</c:if>
			<c:if test="${requestScope.page.currentPage != requestScope.page.pageCount }">
				<a href="${pageContext.request.contextPath}/newstype/column/${requestScope.newsType.id }/${requestScope.page.currentPage }+1">下一页</a>
			</c:if>
			<a href="${pageContext.request.contextPath}/newstype/column/${requestScope.newsType.id }/${requestScope.page.pageCount }">尾页</a>
			当前第
